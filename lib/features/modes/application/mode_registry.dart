...
final List<PulseModeDescriptor> kAllModes = [
  ...
  // Paid modes — full interactive implementations, unlocked by
  // subscription. They appear in the catalog grid and as locked tiles
  // on the Hub carousel until the user subscribes.
  PulseModeDescriptor(
